        ...
        f3=new Font("Arial",Font.BOLD,20);
         ...
         c.setBackground(new Color(0,0,0));
           ...
           c.add(label2);
            ...
            label3 = new JLabel("Doctor's Information");
           //label1.setText("Welcome To");
           label3.setBounds(270,30,560,100);
           label3.setForeground(Color.WHITE);
           label3.setFont(f1);
           c.add(label3);
           
           label4 = new JLabel("Hospital:");
           //label1.setText("Welcome To");
           ...
           label5 = new JLabel("Visiting Hours:");
           //label1.setText("Welcome To");
          ...
          button2 = new JButton("Available Time");
           //label1.setText("Welcome To");
           button2.setBounds(481,585,260,50);
